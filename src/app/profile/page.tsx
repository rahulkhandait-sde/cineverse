...
import { Camera, Edit3, Save, X, User, Mail, Phone, MapPin, Calendar, Globe, Star, Film, Eye, Heart } from 'lucide-react';
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/20 p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="text-center p-3 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl border border-blue-200/20">
                  ...
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">{profileData.stats.watchedMovies}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Watched</div>
                </div>
                <div className="text-center p-3 bg-gradient-to-r from-red-500/10 to-pink-500/10 rounded-xl border border-red-200/20">
                  ...
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">{profileData.stats.favoriteMovies}</div>
                ...
                <div className="text-center p-3 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-xl border border-green-200/20">
                  ...
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">{profileData.stats.watchlistCount}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Watchlist</div>
                </div>
                <div className="text-center p-3 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-xl border border-yellow-200/20">
                  ...
                  <div className="text-2xl font-bold text-gray-900 dark:text-white">{profileData.stats.reviews}</div>
