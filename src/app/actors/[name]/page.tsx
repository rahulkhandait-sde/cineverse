                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                >
                                    <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <span className="font-semibold">{actor.birthYear} ({age} years old)</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                    ...
                                    <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                                        ...
                                        <span className="font-semibold">{actor.movies.length} movies</span>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    <div className="p-4 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-xl border border-purple-500/20">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-sm font-semibold text-gray-600 dark:text-gray-400">Movies</span>
                                        </div>
                                    ...
                                    <div className="p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-xl border border-blue-500/20">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-sm font-semibold text-gray-600 dark:text-gray-400">Genres</span>
                                        </div>
                    ...
                    <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="prose prose-lg dark:prose-invert max-w-none">
                                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                                        {actor.name} is a renowned {actor.nationality} actor born in {actor.birthYear}. 
                                        With a career spanning multiple decades, {actor.name} has established themselves 
                                        as one of the most versatile and talented performers in the entertainment industry.
                                    </p>
                                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                                        Known for their exceptional work in {actor.genres.slice(0, 3).join(', ')}, 
                                        {actor.name} has delivered memorable performances in over {actor.movies.length} films, 
                                        earning critical acclaim and audience appreciation worldwide.
                                    </p>
                                </div>
                            </motion.div>
                        )}
                                    ...
                                    <div>
                                        <div className="mb-8 p-6 bg-white/80 dark:bg-black/40 backdrop-blur-xl border border-gray-200/50 dark:border-white/10 rounded-2xl shadow-2xl">
                                            ...
                                            <p className="text-gray-600 dark:text-gray-400">
                                                {actorMovies.Search.length} movies found featuring {actor.name}
                                            </p>
                                        </div>
                        ...
                        {activeTab === 'stats' && (
                            <motion.div
                                ...
                                className="p-8 bg-white/90 dark:bg-black/60 backdrop-blur-xl border border-gray-200/50 dark:border-white/10 rounded-3xl shadow-2xl"
                            >
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Career Statistics</h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    <div className="p-6 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl border border-purple-500/20">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Total Movies</h3>
                                                <p className="text-sm text-gray-600 dark:text-gray-400">Filmography count</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-6 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-2xl border border-blue-500/20">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Genres</h3>
                                                <p className="text-sm text-gray-600 dark:text-gray-400">Diverse roles</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-6 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-2xl border border-emerald-500/20">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Career Years</h3>
                                    ...
                                    <div className="p-6 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-2xl border border-orange-500/20">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Nationality</h3>
