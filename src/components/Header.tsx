                ...
                <div className='relative container mx-auto px-3 sm:px-4 md:px-6 h-14 sm:h-16 md:h-20 lg:h-24 flex items-center justify-between'>
                    ...
                    <Link href='/movies' className='flex items-center gap-1 sm:gap-2 md:gap-4 hover:scale-105 transition-all duration-300 group flex-shrink-0'>
                        ...
                        <div className='flex flex-col min-w-0'>
                            <motion.h1 whileHover={{ scale: 1.05 }} className='text-base sm:text-xl md:text-2xl lg:text-2xl xl:text-3xl font-black bg-gradient-to-r from-gray-900 via-red-600 to-purple-600 dark:from-white dark:via-red-200 dark:to-purple-200 bg-clip-text text-transparent tracking-tight truncate'>
                                CineVerse
                            </motion.h1>
                    ...
                    <div className='hidden md:flex items-center flex-1 justify-start ml-4 lg:ml-8 xl:ml-12'>
                        ...
                        <nav className='flex items-center gap-1 lg:gap-2'>
                            ...
                            <Link
                                href='/movies'
                                className={`relative group px-4 lg:px-6 py-3 transition-all duration-300 font-semibold tracking-wide ${pathname === '/movies'
                            ...
                            <Link
                                href='/watchlist'
                                className={`relative group px-4 lg:px-6 py-3 transition-all duration-300 font-semibold tracking-wide ${pathname === '/watchlist'
                                    ? 'text-gray-900 dark:text-white'
                                    : 'text-gray-700 dark:text-white/90 hover:text-gray-900 dark:hover:text-white'
                                    }`}>
